...
class JetTransportEmptyWeightTestCase(unittest.TestCase):
    def test_B732(self):
        ...
        dvs.add_output("ac|geom|wing|c4_sweep", 25, units="deg")
        ...
        dvs.add_output("ac|geom|hstab|c4_sweep", 30, units="deg")
        ...
        dvs.add_output("ac|geom|vstab|c4_sweep", 35, units="deg")
    ...
    def test_B789(self):
        ...
        dvs.add_output("ac|geom|wing|c4_sweep", 32.2, units="deg")
        ...
        dvs.add_output("ac|geom|hstab|c4_sweep", 36, units="deg")
        ...
        dvs.add_output("ac|geom|vstab|c4_sweep", 40, units="deg")
