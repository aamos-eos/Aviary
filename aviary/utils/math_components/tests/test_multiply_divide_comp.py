...
class TestElementMultiplyDivideCompScalars(unittest.TestCase):
    def setUp(self):
        ...
        multi = self.p.model.add_subsystem(name="multiply_divide_comp", subsys=ElementMultiplyDivideComp())
...
class TestElementMultiplyDivideDivisionFirst(unittest.TestCase):
    def setUp(self):
        ...
        multi = self.p.model.add_subsystem(name="multiply_divide_comp", subsys=ElementMultiplyDivideComp())
        multi.add_equation(
            "multdiv_output", ["input_a", "input_b", "input_c"], vec_size=self.nn, length=3, divide=[True, True, False]
        )
...
class TestElementMultiplyDivideScalingFactor(unittest.TestCase):
    def setUp(self):
        ...
        multi = self.p.model.add_subsystem(name="multiply_divide_comp", subsys=ElementMultiplyDivideComp())
        multi.add_equation(
            "multdiv_output", ["input_a", "input_b", "input_c"], vec_size=self.nn, length=3, scaling_factor=2
        )
...
class TestWrongUnitsCount(unittest.TestCase):
    def setUp(self):
        ...
        multi = self.p.model.add_subsystem(name="multiply_divide_comp", subsys=ElementMultiplyDivideComp())
        multi.add_equation(
            "multdiv_output", ["input_a", "input_b", "input_c"], vec_size=self.nn, length=3, input_units=["kg", "ft"]
        )
...
class TestWrongDivideCount(unittest.TestCase):
    def setUp(self):
        ...
        multi = self.p.model.add_subsystem(name="multiply_divide_comp", subsys=ElementMultiplyDivideComp())
        multi.add_equation(
            "multdiv_output", ["input_a", "input_b", "input_c"], vec_size=self.nn, length=3, divide=[False, True]
        )
...
class TestForDocs(unittest.TestCase):
    def test(self):
        ...
        p.model.add_subsystem(name="ivc", subsys=ivc, promotes_outputs=["mass", "acceleration"])
